...
import com.verallia.CritialIrp
...
class CritialIrpSpec extends Specification implements DataTest
{
    ...
    void setupSpec() {
        mockDomains Model, Line, CritialIrp, Production, Shift, Team
    ...
    {
        given:
        def data = new CritialIrp(params)
